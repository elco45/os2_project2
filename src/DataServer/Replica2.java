...
public class Replica2 extends UnicastRemoteObject implements DSRMI {

    private static File dataDirectory;
    private static ArrayList<Integer> clients = new ArrayList();
    private static Registry reg;

    public Replica2(File dataDirectory2) throws RemoteException {
        super();
    ...
    public static void main(String args[]) {
        try {
            dataDirectory = new File("./Data/Replica2/");
            ...
            reg = LocateRegistry.createRegistry(1105);
            reg.rebind("Replica2", new Replica2(dataDirectory));
            System.out.println("Replica2 started..");

            server.addDataServer("127.0.0.1", 1105, "Replica2");
